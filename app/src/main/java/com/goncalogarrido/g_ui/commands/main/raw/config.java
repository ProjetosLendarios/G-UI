...
import static com.goncalogarrido.g_ui.UIManager.PREFS_NAME;
...
public class config extends ParamCommand {
    ...
    private enum Param implements com.goncalogarrido.g_ui.commands.main.Param {
...
//                    is font
    ...
    @Override
    protected com.goncalogarrido.g_ui.commands.main.Param paramForString(MainPack pack, String param) {
